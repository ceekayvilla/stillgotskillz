                  ...
                  <p>
                    <div class="row">
                      <!---col-one steps-->
                        <div class="col-md-3">
                            <div class="bg-steps">
                                <figure class="step-icon"><img src="{{ asset('public/frontend/images/step-one-icon.png') }}"></figure>
                                  <h2>Step 1:</h2>
                        ...
                        <div class="col-md-3">
                            <div class="bg-steps">
                                <figure class="step-icon"><img src="{{ asset('public/frontend/images/step-two-icon.png') }}"></figure>
                                  <h2>Step 2:</h2>
                        ...
                        <div class="col-md-3">
                            <div class="bg-steps">
                                <figure class="step-icon"><img src="{{ asset ('public/frontend/images/step-three-icon.png') }}"></figure>
                                  <h2>Step 3:</h2>
                        ...
                        <div class="col-md-3">
                            <div class="bg-steps">
                                <figure class="step-icon"><img src="{{ asset ('public/frontend/images/step-four-icon.png') }}"></figure>
                                  <h2>Step 4:</h2>
