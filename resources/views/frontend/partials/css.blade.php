{!!Html::style('public/frontend/css/bootstrap.min.css',array(),env('RESOURCE_SECURE'))!!}
{!!Html::style('public/frontend/css/font-awesome.min.css',array(),env('RESOURCE_SECURE'))!!}
{!!Html::style('public/frontend/css/menu_mobile.css',array(),env('RESOURCE_SECURE'))!!}
